...
- (void)commonInit {
    ...
    _audioManager = [FBAudioManager audioManager];
...
- (void)enableAudio:(BOOL)on {
    ...
    if (on && _decoder.hasAudio) {
        ...
        audioManager.outputHandler = ^(float *outData, UInt32 numFrames, UInt32 numChannels) {
        ...
        [audioManager pause];
        audioManager.outputHandler = nil;
    }
}
