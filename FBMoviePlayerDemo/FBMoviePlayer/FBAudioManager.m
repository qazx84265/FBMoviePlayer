...
//    }
    ...
    error = nil;
    result = [[AVAudioSession sharedInstance] setPreferredIOBufferDuration:preferredBufferSize error:&error];
    if (!result || error) {
...
//        return NO;
    ...
    newNumChannels = (UInt32)[AVAudioSession sharedInstance].outputNumberOfChannels;
